...
# SYNOPSIS
#
#   AX_C_VARIABLE_ATTRIBUTE(ATTRIBUTE[, ACTION-IF-FOUND[, ACTION-IF-NOT-FOUND]])
#
# DESCRIPTION
#
...
#
#   If ATTRIBUTE is supported define HAVE_VARIABLE_ATTRIBUTE_<ATTRIBUTE>.
#
...
AC_DEFUN([AX_C_VARIABLE_ATTRIBUTE], [
    ...
    AS_IF([test yes = AS_VAR_GET([ac_var])],
        [ifelse([$2],,[AC_DEFINE_UNQUOTED(AS_TR_CPP(HAVE_VARIABLE_ATTRIBUTE_$1), 1, [Define to 1 if the system has the `$1' variable attribute])],[$2])],
	[$3])
