...
# SYNOPSIS
#
#   AX_C___ATTRIBUTE__([ACTION-IF-FOUND[, ACTION-IF-NOT-FOUND]])
#
# DESCRIPTION
#
...
AC_DEFUN([AX_C___ATTRIBUTE__], [
  ...
  AS_IF([test "$ax_cv___attribute__" = "yes"],
    [ifelse([$1],,[AC_DEFINE([HAVE___ATTRIBUTE__], 1, [define if your compiler has __attribute__])],[$1])],
    [$2])
